    ...
    <x-settings.layout :heading="__('Actualizar contraseña')" :subheading="__('Asegúrate de usar una contraseña larga y aleatoria para mantener tu cuenta segura')">
        ...
        @if ($canManageTwoFactor)
            <section class="mt-12">
                ...
                <flux:subheading>{{ __('Gestiona tus ajustes de autenticación en dos pasos') }}</flux:subheading>
        ...
        @if ($canManagePasskeys)
            <section class="mt-12">
                ...
                <flux:subheading>{{ __('Gestiona tus passkeys para iniciar sesión sin contraseña') }}</flux:subheading>
                    ...
                    <div class="border rounded-lg border-zinc-200 dark:border-zinc-700 overflow-hidden">
                        ...
                        @empty
                            <div class="p-8 text-center">
                                ...
                                <p class="font-medium">{{ __('Todavía no tienes passkeys') }}</p>
                                <flux:text class="mt-1">{{ __('Añade una passkey para iniciar sesión sin contraseña') }}</flux:text>
                            </div>
                        @endforelse
                    </div>
