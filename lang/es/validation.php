...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor indicado para :attribute ha aparecido en una filtración de datos. Elige un :attribute distinto.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'company_id' => 'empresa',
        'history' => 'historial',
        'history.status' => 'estado del evento',
        'history.location' => 'ubicación del evento',
        'history.description' => 'descripción del evento',
        'history.recorded_at' => 'fecha del evento',
        'shipment_id' => 'pedido',
